...
def detect_score(
    ...
    for pattern in patterns:
        ...
        # جلوگیری از تشخیص اشتباه تاریخ،
        # شماره خبر و اعداد عادی.
        #
        # در بسکتبال معمولاً حداقل یکی
        # از امتیازها 30 یا بیشتر است.
...
def detect_basketball(
    ...
    # نکته مهم:
    # چون ورودی یک متن کامل خبری است،
    # باید از find_league_in_text استفاده شود،
    # نه find_league که فقط تطابق کامل را بررسی می‌کند.
    ...
    # اگر نتیجه پیدا شد،
    # نوع خبر Result در نظر گرفته می‌شود.
